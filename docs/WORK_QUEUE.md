...
| P2 | in-progress | Add link health and catalog freshness checks | build-agent | PR #24 adds deterministic URL inventory, source-migration replay, and bounded live link diagnostics; independent integrity review passed for the current implementation, while broader catalog freshness/age policy remains |
