...
| P2 | in-progress | Add link health and catalog freshness checks | build-agent | Source history is canonical through Aug. 26. PR #101 merged a provenance-preserving derived correction for the Aug. 27 PR #75 snapshot without rewriting the invalid-hash raw evidence; its exact head and post-merge Core/Pages checks are green. Next create a separate bounded canonical replay PR using `intelligence/feeds/2026-08-27-source-health-reconciled.json`, require exactly five verified predecessor/hash pairs, advance only matching registry timestamps, and rerun source/history/report/intelligence/site-data/Agent Operations/Core/Maintenance validation. Aug. 28 PR #82, Aug. 29 PR #85/#91, and Aug. 30 PR #95/#99 raw research are already preserved on `main` but remain chronology-blocked behind Aug. 27. Open PR #103 (Aug. 31 morning) and PR #106 (Aug. 31 afternoon) are later one-file contributed-research lanes with green Core heads but stale bases; preserve and reconcile them only after Aug. 27-Aug. 30 are canonical. xTech|Search 10 remains non-actionable until its authoritative RFI/application conflict is resolved. |
